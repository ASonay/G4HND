...
{ 
  ...
  for(unsigned int i=20; i<=20000; i=i+20)
    {
      FN = i;
      sprintf(filename, "neutron_beam_%ikeV.in", FN);
	...
	{ 
      ...
      outfile<<"/ND/RecMsg/FileName root_files/neutron/neutron_"<<FN<<"keV.root"<<endl;
      ...
      outfile<<"/gps/particle neutron"<<endl;
      outfile<<"/gps/energy "<< i<<" keV"<<endl;
      outfile<<"/gps/direction 0 0 -1"<<endl;
      outfile<<"/run/beamOn 10000"<<endl;
